    ...
    return (
        <div className='relative py-20'>
            <div className="mx-auto">
                ...
                <div className='flex justify-center gap-[22px] mt-14'>
                    <button className='text-center bg-[#F8F8F8] border-[0.5px] border-[#545454] hover:bg-[#FD6F00] hover:text-white rounded-xl text-[24px] font-normal leading-9 tracking-[0.03em] px-5 py-[10px]'>All</button>
                    <button className='text-center bg-[#F8F8F8] border-[0.5px] border-[#545454] hover:bg-[#FD6F00] hover:text-white rounded-xl text-[24px] font-normal leading-9 tracking-[0.03em] px-5 py-[10px]'>UI/UX</button>
                    <button className='text-center bg-[#F8F8F8] border-[0.5px] border-[#545454] hover:bg-[#FD6F00] hover:text-white rounded-xl text-[24px] font-normal leading-9 tracking-[0.03em] px-5 py-[10px]'>Web Design</button>
                    <button className='text-center bg-[#F8F8F8] border-[0.5px] border-[#545454] hover:bg-[#FD6F00] hover:text-white rounded-xl text-[24px] font-normal leading-9 tracking-[0.03em] px-5 py-[10px]'>App Design</button>
                    <button className='text-center bg-[#F8F8F8] border-[0.5px] border-[#545454] hover:bg-[#FD6F00] hover:text-white rounded-xl text-[24px] font-normal leading-9 tracking-[0.03em] px-5 py-[10px]'>Graphic Design</button>
                </div>
                <div className="flex flex-col items-center mt-24">
                    <div className="grid grid-cols-1 sm:grid-cols-1 xl:grid-cols-3 gap-[30px]">
                        <div className="relative rounded-[14px] col-span-1 w-[445px] h-[601px] flex flex-col">
